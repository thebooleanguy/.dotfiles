...
complete -c node -l experimental-global-customevent -d 'Expose the CustomEvent on the global scope'
...
complete -c node -l trace-atomics-wait -d 'Print short summaries of calls to Atomics. wait()'
