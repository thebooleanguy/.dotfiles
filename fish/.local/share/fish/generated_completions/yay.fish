...
complete -c yay -s f -l fish -d 'During complete adjust the output for the fish shell'
...
complete -c yay -s n -l numberupgrades -d 'Deprecated, use yay -Qu and wc -l instead%'
complete -c yay -s s -l stats -d 'Displays information about installed packages and system health'
complete -c yay -s u -l upgrades -d 'Deprecated, use yay -Qu instead%'
...
complete -c yay -l force -d 'Force download for ABS packages that already exist in the current directory'
...
complete -c yay -l upgrademenu -d 'Show a detailed list of updates in a similar format to VerbosePkgLists'
...
complete -c yay -l noupgrademenu -d 'Do not show the upgrade menu'
