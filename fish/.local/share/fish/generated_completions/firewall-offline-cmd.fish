...
complete -c firewall-offline-cmd -l query-helper -d 'Return whether the helper has been added to the permanent service'
...
complete -c firewall-offline-cmd -l query-destination -d 'Return whether the destination ipv to address[/mask] has been set in the perm…'
...
complete -c firewall-offline-cmd -l query-include -d 'Return whether the include has been added to the permanent service'
