...
complete -c qemu-system-i386 -o soundhw -o soundhw -d 'Enable audio and selected sound hardware'
...
complete -c qemu-system-i386 -o curses -d 'Normally, if QEMU is compiled with graphical window support, it displays outp…'
complete -c qemu-system-i386 -o alt-grab -d 'Use Ctrl-Alt-Shift to grab mouse (instead of Ctrl-Alt)'
complete -c qemu-system-i386 -o ctrl-grab -d 'Use Right-Ctrl to grab mouse (instead of Ctrl-Alt)'
complete -c qemu-system-i386 -o sdl -d 'Enable SDL'
...
complete -c qemu-system-i386 -o watchdog -d 'Create a virtual hardware watchdog device'
...
complete -c qemu-system-i386 -o enable-fips -d 'Enable FIPS 140-2 compliance mode'
